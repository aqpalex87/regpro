   ...
   public class FileService : IFileService
    {
        ...
        {
            var target = Path.Combine(_hostingEnvironment.ContentRootPath, "Files");
        ...
        public (string fileType, byte[] archiveData, string archiveName) DownloadFiles()
        {
            ...
            var files = Directory.GetFiles(Path.Combine(_hostingEnvironment.ContentRootPath, "Files")).ToList();
