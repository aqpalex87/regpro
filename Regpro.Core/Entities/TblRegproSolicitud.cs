...
{
    public partial class TblRegproSolicitud : BaseEntity
    {
        public TblRegproSolicitud()
        {
            DetRegproSolDocs = new HashSet<DetRegproSolDoc>();
            DetRegproSolcams = new HashSet<DetRegproSolcam>();
            TblRegproAccsolis = new HashSet<TblRegproAccsoli>();
        }
        ...
        [NotMapped]
        public  TblRegproDocumento Documento { get; set; }
        [NotMapped]
        ...
        public virtual ICollection<TblRegproAccsoli> TblRegproAccsolis { get; set; }
    }
}
